...
P6 Planner API + Persistence — hardened `docs/steps/step6.md` Cursor build contract and the locked behaviors for trips persistence, SSE generate HTTP, trips CRUD/GeoJSON, swappable Redis backends, and ship checklist (design change `design-p6-planner-api-persistence`).
