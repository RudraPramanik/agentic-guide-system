...
Bounded-concurrency pairwise travel matrix for `OsrmRoutingProvider` so day optimization completes within planner generation timeouts under public OSRM latency.
