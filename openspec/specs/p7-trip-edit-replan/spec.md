...
P7 day-scoped trip edit HTTP API and TripService day surgery (v2.1 locks from `docs/steps/step7.md`). Implementation lands in steps 7.1–7.4; this spec is the behavior contract.
