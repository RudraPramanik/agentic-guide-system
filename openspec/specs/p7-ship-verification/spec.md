...
P7.6 ship verification — optional `scripts/test_p7_smoke.py`, edit-path import guards, full pytest green, and `docs/context.md` P7-complete stamp only after green.
