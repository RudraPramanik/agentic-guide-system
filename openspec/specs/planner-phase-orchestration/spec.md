...
P5.5 registry orchestration: preconditions, deterministic phase transitions, and `apply_tool_result` as the sole TravelState writer from tool outcomes (tool_trace / tool_loop_count bookkeeping).
