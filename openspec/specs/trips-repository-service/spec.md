...
Trip repository and service persistence for P6.1 — exceptions, response schemas, Unit of Work `save_from_state`, ownership policy, and claim helpers (no HTTP router; claim HTTP lands in 6.3).
