...
P4 Travel Engine layer contract: hardened `docs/steps/step4.md` build prompt plus pure-Python intelligence (selection through validation), planner routing adapter stub, CORS, and verification bar — aligned with `docs/blueprint_final.md` v6.1.
