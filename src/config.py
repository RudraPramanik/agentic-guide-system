...
class Settings(BaseSettings):
    ...
    RATE_LIMIT_DESTINATIONS_RESOLVE_REQUESTS: int = 20
    RATE_LIMIT_DESTINATIONS_RESOLVE_WINDOW_SECONDS: int = 60
    RATE_LIMIT_DESTINATIONS_RESOLVE_PATH: str = "/api/v1/destinations/resolve"
